    ...
    <div style="height: 100vh;">
        <div style="overflow-y: auto;margin: 10px;display:flex;flex-direction:column;">
            <div class="demo-card-square mdl-card "
                ...
                <dialog class="mdl-dialog" style="width: 100%;margin: 80px 20px 0 20px;background-color: #333;">
                ...
                <div class="mdl-card__supporting-text" :style="mystyle" style="width:99%;">
                    ...
                    <div v-else style="color:#CCC;line-height:1.01;display: inline-block;" v-for="(item, index) in arts"
                        :key="index">
                        <button type="button" class="show-modal" style="margin-right: 5px;border: 1px groove #0F0;"
                            v-if="an.includes(index)" @click="open(index)">
                            {{ item }}
                        </button>
