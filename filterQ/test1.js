...
",
            ...
            q_ex:["文章第一句就提到 Alzheimer's disease 是一種「progressive brain disorder」，因此答案為 B。
...
C. Genetics
D. Smoking
","文章中提到 Alzheimer's disease 是由於「the buildup of abnormal proteins in the brain」所引起，因此答案為 A。
...
","文章中提到目前沒有針對 Alzheimer's disease 的治療方法，只有一些可以幫助緩解症狀的藥物，因此答案為 B。
...
","文章中提到研究人員使用「ultrasound waves to stimulate microglial cells in the brain」以清除掉引起 Alzheimer's disease 的異常蛋白質，因此答案為 B。
...
","文章中提到這項研究仍處於早期階段，需要更多的研究才能確定同樣的方法是否對人類有效，因此答案為 C。文中也提到研究結果具有前途，但仍需要進一步的研究。
...
",],
            q_a:[" B. A progressive brain disorder.
...
",
            ...
            q_ex:["文章開頭就提到全球氣溫上升，顯然地指出了氣候變遷成為一個越來越迫切的問題，因此答案為 D。
...
","文章中提到 renewable energy 是指那些來源是自然再生的，可以使用而不會耗盡有限資源的能源，因此答案為 C。
...
","文章中列舉了太陽能、風能和水能等能源，這些都是 renewable energy sources 的例子，因此答案為 C。
...
","文章中提到 renewable energy sources 相較於傳統的化石燃料，例如煤炭和石油，會產生較少的排放物，因此答案為 D。
...
","文章中提到 renewable energy sources 通常比傳統能源更昂貴，因此需要更多的研究和發展來使其更有效率和具有成本效益，因此答案為 A。
...
",],
            q_a:[" D. Global temperatures are rising.
...
",
            ...
            q_ex:["文章中提到花費超過每天兩個小時在社交媒體上的人，更有可能出現社交孤立和抑鬱的感覺，因此答案為 D。
...
","文章中提到社交媒體可以通過傳播不實信息和謠言對心理健康造成影響，因此答案為 C。
...
D. By connecting people from all over the world.
","文章中提到社交媒體平台經常呈現人們生活的理想化版本，使用者可能感到需要符合這些不現實的標準，這可能導致自卑和低自尊心，因此答案為 B。



",],
            q_a:[" D. People who spend more than two hours a day on social media are more likely to experience feelings of social isolation and depression.
...
",
            q:["What is one concern about the impact of social media on mental health?","How can social media contribute to mental health problems?","What is one way that social media can lead to feelings of inadequacy and low self-esteem?","How can social media be a source of support and community?","What is one way to use social media in a responsible way?",],
            q_sel:[[" Social media platforms can only connect people from certain parts of the world."," Social media platforms have no negative effects on mental health."," People who use social media are less likely to experience feelings of social isolation and depression."," People who spend more than two hours a day on social media are more likely to experience feelings of social isolation and depression."],[" By presenting realistic versions of people's lives."," By providing users with accurate information."," By spreading rumors and misinformation."," By connecting people from all over the world."],[" By providing users with support and community."," By presenting idealized versions of people's lives."," By spreading accurate information."," By connecting people from all over the world."],[" By presenting idealized versions of people's lives."," By spreading rumors and misinformation."," By connecting people from all over the world."," By limiting users' exposure to other people's posts."],[" By spending more than two hours a day on social media."," By conforming to unrealistic standards presented on social media platforms."," By being aware of the potential risks and using social media in a balanced way."," By spreading rumors and misinformation."],],
            q_ex:["文章指出，每天在社交媒體上花費超過兩個小時的人更有可能體驗到社交孤立和抑鬱的感覺，所以答案是 D。
...
C. By spreading rumors and misinformation.
D. By connecting people from all over the world.
","文章指出，社交媒體可以通過傳播錯誤信息和謠言來影響心理健康，這會導致焦慮和困惑，所以答案是 C。
...
C. By spreading accurate information.
D. By connecting people from all over the world.
","文章指出，社交媒體平台經常呈現人們生活的理想化版本，用戶可能會因為遵守這些不切實際的標準而感到壓力，這會導致自卑感和自卑感，所以答案是 B。
...
","文章指出社交媒體可以成為某些人的支持和社區來源，所以答案是 C。
...
","文章指出以平衡和負責任的方式使用社交媒體並意識到潛在風險很重要，所以答案是 C。",],
            q_a:[" D. People who spend more than two hours a day on social media are more likely to experience feelings of social isolation and depression.
